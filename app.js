...
function init() {
    ...
    fetchAllPairs()
        .then(pairs => {
            ...
            const message = `¡Hola, comunidad de Full Scalping! 🐍💥

Es un placer estar aquí con todos ustedes. Para los que no me conocen, soy el bot de alertas de debilitamiento de precio, y estaré acompañándolos en este viaje de formación y trading. Mi misión es simple: avisarles cuando detecto un posible debilitamiento en la subida del precio, para que puedan tomar decisiones más informadas en sus operaciones. Recuerden: estas no son señales de entrada, sino alertas para que estén atentos y analicen el contexto del mercado. 📉🔍
        
En Full Scalping no nos enfocamos en prometerles que serán millonarios de la noche a la mañana (ya saben, eso es pura pendejada). Aquí trabajamos en lo que realmente importa: la psicología del trader, la disciplina y la consistencia. Operar en corto (short) no es solo una estrategia, es una mentalidad. Y para dominarla, hay que dejar de lado las emociones y las expectativas irreales. 💪🧠
        
Así que, ya sean alumnos, curiosos o buscadores de estrategias mágicas, recuerden: el éxito en el trading no se trata de encontrar el "santo grial", sino de trabajar en ustedes mismos, entender el mercado y gestionar el riesgo. Aquí estamos para ayudarlos en ese proceso. 🚀
        
¡Estén atentos a mis alertas y sigan aprendiendo! Si tienen dudas, no duden en consultar a los mentores de la academia. ¡Vamos a por esas operaciones! 💥📊
        
#FullScalping #Trading #PsicologíaDelTrader #NoSeasPendejo 🐍🔥`;
...
// FUNCIÓN PARA CHEQUEAR DIVERGENCIA
...
function createAlert(data) {
    ...
    const telegramMessage = `🚨 ¡ALERTA DE DEBILITAMIENTO DETECTADA! 🚨

 ══════════════════════
      🔻 [${data.pair}](${tradingViewLink}) 🔻 
 ══════════════════════

📉 Posible pérdida de fuerza en el movimiento actual.

📌 Detalles:
🔹 Par: [${data.pair}](${tradingViewLink})
🔹 Temporalidad: ⚡ 5M 
🔹 Condición: Pérdida de impulso y posible giro

⚠️ ATENCIÓN: Esto NO es una señal de entrada, sino una advertencia para analizar el contexto antes de operar.

🔎 Revisá antes de actuar:
📊 Volumen 📉
📈 Estructura del precio 🏗️
✅ Confirmaciones 🔍

🔥 Estrategia: PENTA TRADE 🔥

#FullScalping #Trading #AlertaDebilitamiento 🐍🔥`;
